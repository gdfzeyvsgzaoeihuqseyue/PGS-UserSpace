<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
    ...
    <div class="flex h-[calc(100vh-4rem)]">
      <!-- Sidebar Navigation -->
      <aside
        class="flex-shrink-0 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 transition-all duration-300 ease-in-out overflow-y-auto"
        :class="[
      ...
      <!-- Overlay for mobile -->
      <div v-if="showMobileMenu" class="fixed inset-0 bg-gray-900 bg-opacity-50 z-30 lg:hidden"
