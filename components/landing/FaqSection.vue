  ...
  <section class="relative py-24 overflow-hidden bg-white dark:bg-slate-900">
    ...
    <div class="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="max-w-3xl mx-auto space-y-4">
        <!-- Loading State -->
        <div v-if="faqStore.loading" class="space-y-4">
          <div v-for="i in 4" :key="i" class="bg-slate-100 dark:bg-slate-800 h-24 rounded-2xl animate-pulse"></div>
        </div>

        <!-- FAQs -->
        <div v-else-if="faqStore.faqs.length > 0" class="space-y-4">
        ...
        <!-- Refresh Action -->
        <div v-if="!faqStore.loading && faqStore.faqs.length > 0" class="text-center mt-8">
