<template>
  <section v-if="pending || currentPartners.length > 0" class="py-16 bg-WtBAct">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center">
        ...
        <div v-else class="mt-8 flex flex-wrap justify-center gap-8 md:gap-16 opacity-70">
...
onMounted(() => {
  updatePartners()
  intervalId = setInterval(updatePartners, 15 * 1000) // 15 secondes
})
